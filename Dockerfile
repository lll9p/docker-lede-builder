...
RUN apt-get update  \
    ...
    automake libtool autopoint help2man time perl-modules rsync intltool device-tree-compiler g++-multilib linux-libc-dev-i386-cross ca-certificates libevent2-openssl libevent2-pthreads \
